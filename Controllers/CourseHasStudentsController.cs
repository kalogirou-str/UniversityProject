...
namespace UniversityProject.Controllers
{
    public class CourseHasStudentsController : Controller
    {
        ...
        public CourseHasStudentsController(UniversityDBContext context)
        {
            _context = context;
        }
        ...
        {
            var universityDBContext = _context.CourseHasStudents.Include(c => c.CourseIdCourseNavigation).Include(c => c.StudentsRegistrationNumberNavigation);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'UniversityDBContext.CourseHasStudents'  is null.");
            }
            var courseHasStudent = await _context.CourseHasStudents.FindAsync(id);
            if (courseHasStudent != null)
            {
